...
ggplot(
  gp_covid, 
  aes(x = as.factor(age_cat), y = sum_trust)) + 
  geom_boxplot()
```
]
]
...
# [Exercise](https://jobreu.github.io/r-intro-gesis-2021/exercises/Exercise_3_2_3_lotting_Repeats.html) time `r emo::ji("weight_lifting_woman")``r emo::ji("muscle")``r emo::ji("running_man")``r emo::ji("biking_man")`

## [Solutions](https://jobreu.github.io/r-intro-gesis-2021/solutions/Exercise_3_2_3_lotting_Repeats.html)

---

## Goind further: Working with grouping variables
...
(my_barplot | ~barplot(table(gp_covid$age_cat))) /
...
## Now, what about visualizing explorative statistics?
