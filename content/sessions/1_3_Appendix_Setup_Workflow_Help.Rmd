...
Unless you [change the default settings in *RStudio* as suggested in the "Getting Started" session](https://jobreu.github.io/r-intro-gesis-2021/slides/1_1_Getting_Started.html#67), it will save the workspace in a file called `.RData` in your current working directory and restore the workspace when you restart it. 
