...
```{r, rmarkdown-example, out.width = "60%", echo = F}
...
```{r, rmarkdown-annotated, out.width = "70%", echo = F}
...
.center[<img src="./rmarkdown_process.png" width="80%">]
...
If [WYSIWIG](https://en.wikipedia.org/wiki/WYSIWYG) is more your thing, you can rejoice as new(er) versions of *RStudio* (v. 1.4 or higher) now offer a [Visual `R Markdown`](https://rstudio.github.io/visual-markdown-editing/#/) editor. If you have an `.Rmd` document open in *RStudio*, you can open the visual editor via the GUI,

```{r, visual-rmd-open, out.width = "50%", echo = F}
...
You can then use the visual editor in *RStudio* for editing your `R Markdown` document in a similar as you would, e.g., do in *Microsoft Word*.

```{r, visual-rmd, out.width = "50%", echo = F}
...
Another good options for creating websites with `R Markdown` is [`distill`](https://rstudio.github.io/distill/), which is geared a bit more towards blogging. There are also plenty of tutorials on this online, such as this [blog post by Yury Zablotski](https://yuzar-blog.netlify.app/posts/2020-12-26-how-to-create-a-blog-or-a-website-in-r-with-distill-package/) or this [*YouTube* video tutorial by Lisa Lendway](https://www.youtube.com/watch?v=Fm3bsYCilEU).
