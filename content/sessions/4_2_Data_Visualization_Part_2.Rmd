...
.pull-right[
```{r ref.label = "check-outliers", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "easystats-coef-plot", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "labels-change", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "labels-change-2", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "predictions", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "predictions-nicer", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "interaction-plot", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "interaction-plot-colors", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "comparing-parameters-adjusted", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "all-in-one", echo = FALSE, out.width = "80%"}
```
]
...
.pull-right[
```{r ref.label = "only-two", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "only-two-AME", echo = FALSE, out.width = "85%"}
```
]
...
.pull-right[
```{r ref.label = "programmy-alternative-plot", echo = FALSE, out.width = "90%"}
```
]
