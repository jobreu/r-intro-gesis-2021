...
Say, e.g., we are interested in how the relationship between age and trust varies between different party supporters. We could estimate such a relationship in form of an interaction effect. But let's just stick with estimating separate models for demonstration.
