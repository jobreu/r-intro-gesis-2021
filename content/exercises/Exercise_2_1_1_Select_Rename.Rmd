...
As the final task in this set of exercises, do the previous selection and renaming object using `dplyr` functions again for the `gp_covid_info` object, but this time in one step.
```
